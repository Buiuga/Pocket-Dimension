...
// Helper function with Billions support
...
const WorkPanel = ({ game }) => {
  ...
  return (
    <div className="w-full max-w-5xl grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 pb-20">
      {/* 2. TOTAL STATS DASHBOARD */}
      <div className="col-span-1 sm:col-span-2 lg:col-span-3 w-full bg-gray-950/20 border border-orange-500/50 rounded-2xl p-4 mb-4 text-center backdrop-blur-sm shadow-xl">
        ...
        <div className="flex flex-wrap justify-center gap-2 md:gap-4 text-xs md:text-sm">
          ...
          {/*Artifact Cost*/}
          <div className="px-3 py-2 bg-pink-900/30 rounded-lg border border-pink-500/20 text-pink-100 flex flex-col items-center min-w-[80px]">
            <div className="text-gray-400 text-[10px] uppercase">
              Artifact Cost
            </div>
            <div className="font-bold text-base md:text-lg">
              -{getPercent(bonuses.artifactCostMult)}
            </div>
          </div>
          ...
          <div className="px-3 py-2 bg-emerald-900/30 rounded-lg border border-emerald-500/20 text-emerald-100 flex flex-col items-center min-w-[80px]">
            ...
            <div className="font-bold text-base md:text-lg">
              +{formatNumber(bonuses.passivePerSec)}/s
            </div>
          </div>
        </div>
      </div>
