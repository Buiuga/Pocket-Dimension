...
const DopamineInc = () => {
  ...
  // UPDATED: Cleaner number formatting
  ...
  const displayLabel =
    view === "collection" ? "Total Dopamine Earned" : "Current Dopamine";

  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-950/50 via-orange-900/90 to-orange-950/50 p-4 md:p-8 flex flex-col items-center">
      <button
        ...
        <div className="flex flex-col items-center">
          ...
          {view !== "collection" && game.totalDPS > 0 && (
            <div className="text-emerald-300 font-bold text-sm md:text-base mt-1 animate-pulse">
              (+{" "}
              {game.totalDPS < 10
                ? game.totalDPS.toFixed(1)
                : formatNumber(game.totalDPS)}{" "}
              / sec)
            </div>
          )}
        </div>
